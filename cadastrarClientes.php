...
<body>
  ...
  <div class="container">
    ...
    <form class="row g-3" method="post" action="controller/ControllerCadastro.php?funcao=cadastro" >
      ...
      <div class="col-12">
        ...
        <input type="text" class="form-control sp_celphones" name="txtTelefone" id="inputAddress" placeholder="(11)11111-1111">
      </div>
  ...
  <script src="./bootstrap/lib/jquery.mask.min.js"></script>
